    ...
    <section class="content">
        <div class="col-md-6">
            <div class="box box-danger box-solid">
                ...
                <div class="box-body">
                    <form method="POST" action="<?php echo base_url('post/add_video'); ?>" id="add_post_image" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div id="cropImage">
                                <input id="file" type="file" name="image_file" onchange="readURL(this);"  accept="video/mp4" required>
