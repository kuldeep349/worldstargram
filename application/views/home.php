...
<div class="cp_banner_full_width">
    <div class="item">
        <span class="covertext"  data-toggle="modal" data-target="#profilevideopopup"> 
            Edit Cover Video
        </span>
        <div class="propicss">
            <img class="img-responsive pull-left " style="" src="<?php echo base_url('uploads/' . $userinfo['image']); ?>" alt="User profile picture">
            <br>
            <b class="text-center" data-toggle="modal" data-target="#profileimagepopup">Change Profile Pic</b>
        </div>
        <?php
...
<div class="row">
    <div class="container">
        ...
        <div class="col-md-9 my">
            <!--            <ul style="display: inline-flex; margin-top: 23px;">
                            <li class="my"> <i class="fa fa-picture-o new1" aria-hidden="true"></i>Photos<li/>
                            <li> <i class="fa fa-video-camera new1" aria-hidden="true"></i> Videos<li/>
                            <li> <i class="fa fa-youtube-play new1" aria-hidden="true"></i>Youtube Posts<li/>
                            <li>Constants <li/>
                            <li>Fans<li/>
            ...
            <!--            <div class="rbutton">
                            <ul class="bg-none">
                                <li>Favorites<br>2</li>
                                <li>Followers<br>2</li>
                                <li>Following<br>2</li>
                                <li>Photo/Video<br>2</li>
                                <li>Update Status<br>2</li>
                            </ul>
...
<div class="row">
    <div class="container">
        <div class="col-md-3" style="margin-top:50px;">
            ...
            <button class="btn btn-success" data-toggle="modal" data-target="#profileupdate">Edit Profile</button>
        </div>
        <div class="col-md-6">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        foreach ($users as $user)
                            echo'<li class="list-group-item"><img class="img-circle" style="width: 15%; height: 15%;" src="' . base_url('uploads/' . $user['image']) . '"><a href="'.base_url('User/timeline/'.encrypt($user['id'])).'"><b>' . $user['name'] . ' </b><span class="badge pull-right">' . $user['post_count'] . '</span></li>';
                        ?>
                    </ul>
                </div>
                <?php
